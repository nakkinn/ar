...
function addPerspectiveCameraC(optiona){
    const defaultoption = {fov:60, near:0.01, far:500, pos:[0, -10, 0], up:[0, 0, 1], zoom:1, lookat:[0,0,0]};
    ...
    camera1.position.set(optiona.pos[0], optiona.pos[1], optiona.pos[2]);
    camera1.up.set(optiona.up[0], optiona.up[1], optiona.up[2]);
    camera1.up.normalize();
    camera1.lookAt(optiona.lookat[0], optiona.lookat[1], optiona.lookat[2]);
...
function addOrthographicCameraC(optiona){
    const defaultoption = {near:0.01, far:500, pos:[0, -10, 0], up:[0, 0, 1], zoom:1, lookat:[0,0,0], zoom:1, range:5};
    optiona = {...defaultoption, ...optiona};

...
let tubecolor10 = 0xffffff; //チューブの色A
let tubecolor11 = 0x555555; //チューブの色B
...
let list2a = [];
for(let i=0; i<=detail3; i++) list1a.push((yrange2[1]-yrange2[0])/detail3*i + yrange2[0]);
let list2b = [];
for(let i=0; i<=detail3; i++)   list1b.push((xrange2[1]-xrange2[0])/detail3*i + xrange2[0]);

let utubes_vts_2 = tubeU_vtsC(func2, list1a, xrange2, detail2, 0.015, 6);
let vtubes_vts_2 = tubeV_vtsC(func2, list1b, yrange2, detail2, 0.015, 6);

let utubes_vts0_2 = tubeU_vtsC(func2_bottom, list1a, xrange2, 1, 0.015, 6);
let vtubes_vts0_2 = tubeV_vtsC(func2_bottom, list1b, yrange2, 1, 0.015, 6);

let uvtube_index_2 = tube_indexC(detail2, 6, list1a.length);
let uvtube_index0_2 = tube_indexC(1, 6, list1b.length);

let main_mesh_vts_2 = parametric_vtsC(func2, xrange2, yrange2, detail1, detail1);
...
let list3a = [];
for(let i=0; i<=detail3; i++) list1a.push((yrange3[1]-yrange3[0])/detail3*i + yrange3[0]);
let list3b = [];
for(let i=0; i<=detail3; i++)   list1b.push((xrange3[1]-xrange3[0])/detail3*i + xrange3[0]);

let utubes_vts_3 = tubeU_vtsC(func3, list1a, xrange3, detail2, 0.015, 6);
let vtubes_vts_3 = tubeV_vtsC(func3, list1b, yrange3, detail2, 0.015, 6);

let utubes_vts0_3 = tubeU_vtsC(func3_bottom, list1a, xrange3, 1, 0.015, 6);
let vtubes_vts0_3 = tubeV_vtsC(func3_bottom, list1b, yrange3, 1, 0.015, 6);

let uvtube_index_3 = tube_indexC(detail2, 6, list1a.length);
let uvtube_index0_3 = tube_indexC(1, 6, list1b.length);

let main_mesh_vts_3 = parametric_vtsC(func3, xrange3, yrange3, detail1, detail1);
...
let list4a = [];
for(let i=0; i<=detail3; i++) list1a.push((yrange4[1]-yrange4[0])/detail3*i + yrange4[0]);
let list4b = [];
for(let i=0; i<=detail3; i++)   list1b.push((xrange4[1]-xrange4[0])/detail3*i + xrange4[0]);

let utubes_vts_4 = tubeU_vtsC(func4, list1a, xrange4, detail2, 0.015, 6);
let vtubes_vts_4 = tubeV_vtsC(func4, list1b, yrange4, detail2, 0.015, 6);

let utubes_vts0_4 = tubeU_vtsC(func4_bottom, list1a, xrange4, 1, 0.015, 6);
let vtubes_vts0_4 = tubeV_vtsC(func4_bottom, list1b, yrange4, 1, 0.015, 6);

let uvtube_index_4 = tube_indexC(detail2, 6, list1a.length);
let uvtube_index0_4 = tube_indexC(1, 6, list1b.length);

let main_mesh_vts_4 = parametric_vtsC(func4, xrange4, yrange4, detail1, detail1);
...
let list5a = [];
for(let i=0; i<=detail3; i++) list1a.push((yrange5[1]-yrange5[0])/detail3*i + yrange5[0]);
let list5b = [];
for(let i=0; i<=detail3; i++)   list1b.push((xrange5[1]-xrange5[0])/detail3*i + xrange5[0]);

let utubes_vts_5 = tubeU_vtsC(func5, list1a, xrange5, detail2, 0.015, 6);
let vtubes_vts_5 = tubeV_vtsC(func5, list1b, yrange5, detail2, 0.015, 6);

let utubes_vts0_5 = tubeU_vtsC(func5_bottom, list1a, xrange5, 1, 0.015, 6);
let vtubes_vts0_5 = tubeV_vtsC(func5_bottom, list1b, yrange5, 1, 0.015, 6);

let uvtube_index_5 = tube_indexC(detail2, 6, list1a.length);
let uvtube_index0_5 = tube_indexC(1, 6, list1b.length);

let main_mesh_vts_5 = parametric_vtsC(func5, xrange5, yrange5, detail1, detail1);
...
let xrange6 = [-1*PI, 1.5*PI];   //xの定義域
let yrange6 = [-1*PI, 1.5*PI];   //yの定義域
...
let utubes_vts = tubeU_vtsC(func6, list1, xrange6, detail2, grid_thick, 6);
let vtubes_vts = tubeV_vtsC(func6, list2, yrange6, detail2, grid_thick, 6);

let utubes_vts0 = tubeU_vtsC(func_bottom, list1, xrange6, 1, grid_thick, 6);
let vtubes_vts0 = tubeV_vtsC(func_bottom, list2, yrange6, 1, grid_thick, 6);
...
function zurashi_allC(){
    zurashi_vtsC(main_mesh_vts, -(xrange6[0]+xrange6[1])/2, -(yrange6[0]+yrange6[1])/2, 0);
    zurashi_vtsC(setsuheimen_vts, -(xrange6[0]+xrange6[1])/2, -(yrange6[0]+yrange6[1])/2, 0);
    zurashi_vtsC(pointer_sphere_vts, -(xrange6[0]+xrange6[1])/2, -(yrange6[0]+yrange6[1])/2, 0);
    zurashi_vtsC(redtube_vts, -(xrange6[0]+xrange6[1])/2, -(yrange6[0]+yrange6[1])/2, 0);
    zurashi_vtsC(bluetube_vts, -(xrange6[0]+xrange6[1])/2, -(yrange6[0]+yrange6[1])/2, 0);
    zurashi_vtsC(utubes_vts, -(xrange6[0]+xrange6[1])/2, -(yrange6[0]+yrange6[1])/2, 0);
    zurashi_vtsC(vtubes_vts, -(xrange6[0]+xrange6[1])/2, -(yrange6[0]+yrange6[1])/2, 0);
    zurashi_vtsC(utubes_vts0, -(xrange6[0]+xrange6[1])/2, -(yrange6[0]+yrange6[1])/2, 0);
    zurashi_vtsC(vtubes_vts0, -(xrange6[0]+xrange6[1])/2, -(yrange6[0]+yrange6[1])/2, 0);
    zurashi_vtsC(slice1_vts, -(xrange6[0]+xrange6[1])/2, -(yrange6[0]+yrange6[1])/2, 0);
    zurashi_vtsC(slice2_vts, -(xrange6[0]+xrange6[1])/2, -(yrange6[0]+yrange6[1])/2, 0);
}
...
let surf7b = createMeshC("vts7b", index7b, {color:0xffff00, scale:2.2});   //黄色チューブ
let vts7b2 = tube_vts1C(points2, 0.02, 6);
let surf7b2 = createMeshC("vts7b2", index7b, {color:0xffff00, scale:2.2});  //黄色チューブ

scene7.add(surf7);  //曲面
scene7.add(surf7b); //黄色チューブ
scene7.add(surf7b2);    //黄色チューブ
scene7.add( createMeshC(xaxis, index7b, {scale:2.2, color:0xff0000}) ); //赤チューブ x軸
scene7.add( createMeshC(yaxis, index7b, {scale:2.2, color:0x0000ff}) ); //青チューブ y軸

slider3.func = () =>{
    parameter7 = PI * slider3.value;
    points = [[cos(parameter7), sin(parameter7), sin(2*parameter7)/2], [cos(parameter7+PI), sin(parameter7+PI), sin(2*parameter7)/2]];
...
window.onerror = (message, source, lineno, colno, error)=>{
    alert(message + "\n" + source + "\n" + lineno + "行目");
    document.getElementById("text_debug").textContent = message + "\n" + source + "\n" + lineno + "行目";
}
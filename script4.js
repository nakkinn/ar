...
const func1C = function(u,v){
    ...
    x = u;
    y = (u**3 / 3 + t*u) * 2 - v**2 + 0.5;    //べき乗は**で記述する
    z = v;
    return [x,y,z];
}
...
//グラフィックの追加
addMeshC("vts1", index1, {color:0xffcc00, scale:2, visible:"check1.checked"});    //表示の真偽をチェックボックスの値とする
addMeshC("utubes_vts1", utubes_index1, {color:0xff0000, scale:2, visible:"check2.checked"});
addMeshC("vtubes_vts1", vtubes_index1, {color:0x0000ff, scale:2, visible:"check2.checked"});
